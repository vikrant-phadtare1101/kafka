...
import com.yammer.metrics.core.{Metric, Meter, Histogram}
...
class BrokerTopicMetrics(name: Option[String]) extends KafkaMetricsGroup {
  ...
  def consumerFetchLagTimeInMs = newHistogram(BrokerTopicStats.ConsumerFetchLagTimeInMs, biased = true, tags)
  
  def consumerFetchLagInBytes = newHistogram(BrokerTopicStats.ConsumerFetchLagInBytes, biased = true, tags)
  ...
  def close(): Unit = {
    ...
    removeMetric(BrokerTopicStats.ConsumerFetchLagTimeInMs, tags)
    removeMetric(BrokerTopicStats.ConsumerFetchLagInBytes, tags)
  }
}
...
object BrokerTopicStats {
  ...
  val ConsumerFetchLagTimeInMs = "ConsumerFetchLagTimeInMs"
  val ConsumerFetchLagInBytes = "ConsumerFetchLagInBytes"
